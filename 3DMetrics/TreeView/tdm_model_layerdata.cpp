...
TDMModelLayerData::TDMModelLayerData():m_transparency_value(0.0) {}

TDMModelLayerData::TDMModelLayerData(const QString _filename, const osg::ref_ptr<osg::Node> _node):m_transparency_value(0.0)
{
