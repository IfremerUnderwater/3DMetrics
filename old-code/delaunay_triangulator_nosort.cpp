...
DelaunayTriangulatorNosort::DelaunayTriangulatorNosort():
    osg::Referenced()
{
}

DelaunayTriangulatorNosort::DelaunayTriangulatorNosort(osg::Vec3Array *points, osg::Vec3Array *normals):
    osg::Referenced(),
    points_(points),
    normals_(normals)
{
...
DelaunayTriangulatorNosort::DelaunayTriangulatorNosort(const DelaunayTriangulatorNosort &copy, const osg::CopyOp &copyop):
    osg::Referenced(copy),
...
int DelaunayTriangulatorNosort::getindex(const osg::Vec3 &pt,const osg::Vec3Array *points)
{
...
void DelaunayTriangulatorNosort::_uniqueifyPoints()
{
...
bool DelaunayTriangulatorNosort::triangulate()
{
...
void DelaunayTriangulatorNosort::removeInternalTriangles(osgUtil::DelaunayConstraint *dc )
{
